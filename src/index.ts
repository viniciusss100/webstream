...
import { ConfigureController, ExtractController, ManifestController, StreamController, StreamProxyController } from './controller';
...
addon.use('/', (new StreamProxyController()).router);
